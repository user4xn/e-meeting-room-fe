...
<div class="misc-wrapper">
  ...
  <div class="misc-inner p-2 p-sm-3">
    <div class="w-100 text-center">
      <h2 class="mb-1">Berhasil Verifikasi Email 🚀</h2>
      <p class="mb-3">Terimakasih sudah bergabung dalam sistem ruang rapat (SIRUPAT), Anda akan segera di arahkan ke halaman awal...</p>
