    ...
    <div class="card mb-0">
      <div class="card-body">
        ...
        <p class="card-text mb-2">
          Kami mengirim link ke email anda: <span class="fw-bolder" id="emailText"></span> Ikuti link didalam email untuk melanjutkan.
        </p>

        <a href="{{ route('auth-login') }}" class="btn btn-primary w-100">Kembali</a>

        <p class="text-center mt-2">
          <span>Tidak menerima email ? </span><a href="Javascript:void(0)"><span class="resend-button">&nbsp;Kirim Ulang</span></a>
        </p>
      </div>
    </div>
    <!-- / verify email basic -->
