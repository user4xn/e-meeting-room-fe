          ...
          <li class="timeline-item">
              ...
              <div class="timeline-event">
                  ...
                  <div class="text-start">
                    <span class="badge ${item.organization === 'Internal' ? 'bd-light-success' : 'bg-light-danger'} rounded-pill bg-glow">${item.organization === 'Internal' ? 'Internal KKP' : 'Eksternal'}</span>
                  </div>
              </div>
          </li>
        `;
